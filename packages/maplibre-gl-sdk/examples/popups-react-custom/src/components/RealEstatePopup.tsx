...
export function RealEstatePopup({ property, onFavorite, onViewDetails }: RealEstatePopupProps) {
  ...
  return (
    <div className="real-estate-popup">
      <div className="popup-image-container">
        ...
        <span className="property-type-badge">{propertyTypeLabels[property.propertyType]}</span>
      </div>
